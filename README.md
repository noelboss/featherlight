...
[Official Plugin Website](http://noelboss.github.io/featherlight/)
...
If you want the baclground in IE8 to be translucent, use data:image before the rgba background:
